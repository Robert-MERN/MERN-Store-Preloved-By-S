...
export default function ShoppingCartPage() {
        ...
        const makeRequest = async()=>{
            try {
                ...
                if(product){
                    ...
                    history.push("/success", {order: res.data, id: user._id, product: filteredProduct});
                }
            } catch(err){
                console.error(err);
            }
    ...
    const wishlistItems = useSelector(selectFavorites);
    return (
        <div>
            <Navbar />
            <Announcement/>
            ...
            <CartNavbar>
                ...
                <div className="centre">
                    ...
                    <Link to="/wishlist" style={{color: "inherit", textDecoration: "none"}} >
                        <p>Your Wishlist ({wishlistItems.length})</p>
                    </Link>
                </div>
                <StripeCheckOut
                    label='Pay Now'
