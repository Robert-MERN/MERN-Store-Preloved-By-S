        ...
        <>
            <ParentContainer>
                ...
                <Container direction={slider}>
                    <ChildContainer>
                        <WrapperOne>
                            <img src="images/slicker3.png" alt="" />
                        </WrapperOne>
                        <WrapperTwo>
                            <div>
                                <h1>Summer Sale</h1>
                                <p>This Ramadan We are Bringing Flat Discount of 30% on Every Product, so Grab Your Favourite Items, before you get late</p>
                                <button>Show Now</button>
                            </div>
                        </WrapperTwo>
                    </ChildContainer>
                ...
                <Container direction={slider} >
                    <ChildContainer>
                        <WrapperOne>
                            <img src="images/slicker2.png" alt="" />
                        </WrapperOne>
                        <WrapperTwo>
                            <div>
                                <h1>Ramadan Sale</h1>
